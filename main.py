    ...
    try:
        for i in range(arg, len(links)):
            ...
            if "visionias" in url:
             ...
             url = requests.get(f'https://elearn.crwilladmin.com/api/v5/login-other?url={url}', headers={'x-access-token': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.eyJhY2NpZCI6IjYyMDY0NTkxMjMwMDEiLCJleHAiOjE3MDkzODY1MTAsImlhdCI6MTcwOTMwMDExMCwiY29uaWQiOiI2MzIzNDA3MzM5MTEyIiwibWF4aXAiOjF9'}).json()['url']
