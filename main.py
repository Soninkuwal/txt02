...
async def account_login(bot: Client, m: Message):
    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            V = links[i][1].replace("file/d/", "uc?export=download&id=").replace("www.youtube.com/embed", "youtu.be").replace("vodtenserve.classx.co.in", "dxip4wcd8mhk4.cloudfront.net").replace("www.youtube-nocookie.com/embed", "youtu.be").replace("?modestbranding=1", "").replace("/view?usp=sharing", "").replace("bccareerwill.akamaized.net", "dxip4wcd8mhk4.cloudfront.net").replace("edge.api.brightcove.com","dxip4wcd8mhk4.cloudfront.net").replace("manifest.prod.boltdns.net","dxip4wcd8mhk4.cloudfront.net").replace(')','').replace("d1d34p8vz63oiq", "d26g5bnklkwsh4").replace("pw2.pc.cdn.bitgravity.com","d26g5bnklkwsh4.cloudfront.net").replace("file/d/","uc?export=download&id=").replace("?modestbranding=1", "").replace("/view?usp=sharing","").replace("d3nzo6itypaz07", "d26g5bnklkwsh4").replace("dn6x93wafba93", "d26g5bnklkwsh4").replace("d2tiz86clzieqa", "d26g5bnklkwsh4").replace("vod.teachx.in", "d3igdi2k1ohuql.cloudfront.net").replace("downloadappx.appx.co.in", "d33g7sdvsfd029.cloudfront.net") # .replace("mpd","m3u8")
            url = "https://" + V
